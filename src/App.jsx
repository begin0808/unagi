...
import { ShoppingBag, ChevronDown, Star, MessageCircle, MapPin, Phone, Instagram, Facebook, Clock, CheckCircle, Award, Heart, ShieldCheck, Megaphone, Calendar, Flame, Truck, Utensils, ExternalLink } from 'lucide-react';

// 更新後的產品資料 (移除 image 欄位)
const PRODUCTS = [
  {
    id: 'A',
    code: "A",
