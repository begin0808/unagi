 ...
 * 聯絡方式 —— 網站唯一的來源。
 *
 * 頁尾、常見問題與 index.html 的商家結構化資料都用這裡的資料。
 * 換號碼或換信箱只要改這個檔案（結構化資料在 index.html 需另外手動改一次）。
 */

/** 訂購專線，依序顯示。請填純數字，顯示格式與撥號連結會自動產生 */
export const PHONES = ['0988317218', '0931675289'];

export const CONTACT_EMAIL = 'xingwangeel8899@gmail.com';
...
/** 純文字用的專線清單：0988-317-218 / 0931-675-289 */
